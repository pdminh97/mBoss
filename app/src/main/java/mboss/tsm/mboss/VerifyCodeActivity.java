...
public class VerifyCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextCode = findViewById(R.id.txtCode);
...
//                verifyVerificationCode(code);
//            } else {
//                Toast.makeText(VerifyCodeActivity.this, "code Null", Toast.LENGTH_LONG).show();
//            }
        }
...
//                            startActivity(intent);
                            Toast.makeText(getApplicationContext(), "Di mua cafe", Toast.LENGTH_LONG).show();
